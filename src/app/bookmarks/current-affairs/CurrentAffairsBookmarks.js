...
export default function CurrentAffairsBookmarks() {
  ...
  const removeBookmark = async (bookmarkId, articleTitle) => {
    try {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Your bookmarked current affairs articles for UPSC preparation"
        />
      </Head>
        ...
        {bookmarks.length === 0 ? (
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <Button asChild>
                <Link href="/current-affairs">Browse Current Affairs</Link>
              </Button>
            </CardContent>
          </Card>
        ) : (
