...
export const metadata = {
  ...
  description:
    "Monitor your UPSC preparation progress with personalized dashboard. Track test scores, study materials completion, and performance analytics for Civil Services Exam.",
  keywords:
    "UPSC dashboard, preparation tracking, test scores, study progress, performance analytics, civil services preparation",
};
...
export default function DashboardPage() {
  const structuredData = {
    ...
    description:
      "Personal dashboard for UPSC Civil Services Examination preparation tracking",
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your completion rate across different subjects
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {[
                  { subject: "Indian Polity", value: 85 },
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your latest study sessions and test attempts
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">
                      Studied Indian History Chapter 5
                    </p>
                    <p className="text-xs text-muted-foreground">
