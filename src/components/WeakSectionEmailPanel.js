...
export default function WeakSectionEmailPanel() {
...
Keep pushing forward! 💪`;
      ...
      console.error("Error sending weak section reports:", err);
      toast({
        title: "Error",
        description: err.message || "Failed to send weak section reports",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2">
          <Button onClick={fetchUserCount} variant="outline" className="flex items-center gap-2">
